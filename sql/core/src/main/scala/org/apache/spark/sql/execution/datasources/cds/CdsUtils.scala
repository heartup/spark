...
import com.jdjr.cds.driver.rulebase.{ClusterRuleBase, SplitKeyLocation, SplitTable}

import org.apache.spark.internal.Logging

object CdsUtils extends Logging {
  def getTableLocations(url: String, tableName: String): Array[CDSTableLocation] = {
    ...
    for (loc <- allLoca) {
      tableLocations += CDSTableLocation(loc.getTableSuffix,
